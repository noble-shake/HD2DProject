...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    private int m_MousePrioritySchemeIndex = -1;
    /// <summary>
    /// Provides access to the input control scheme.
    /// </summary>
    /// <seealso cref="UnityEngine.InputSystem.InputControlScheme" />
    public InputControlScheme MousePriorityScheme
    {
        get
        {
            if (m_MousePrioritySchemeIndex == -1) m_MousePrioritySchemeIndex = asset.FindControlSchemeIndex("MousePriority");
            return asset.controlSchemes[m_MousePrioritySchemeIndex];
        }
    }
    /// <summary>
